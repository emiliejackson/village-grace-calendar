...
async function fetchCalendarEvents() {
  ...
  // Multiple page loads can reach a newly started deployment at the same time.
  // Share one upstream request so they do not trigger Google's rate limit.
  ...
  calendarFetchPromise = (async () => {
    try {
      ...
      return cachedCalendarEvents; // Serve stale data during an upstream failure
    } finally {
